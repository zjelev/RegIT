...
namespace Regit.Data.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ControlledById = table.Column<int>(type: "int", nullable: true),
                    ResponsibleId = table.Column<int>(type: "int", nullable: true),
                    Guarantee = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    WaysOfCollection = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contracts_Departments_ControlledById",
                        column: x => x.ControlledById,
                        principalTable: "Departments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Contracts_Departments_ResponsibleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contracts_ControlledById",
                table: "Contracts",
                column: "ControlledById");
